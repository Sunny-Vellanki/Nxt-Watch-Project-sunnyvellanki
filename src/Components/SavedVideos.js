...
const SavedVideos = () => {
    ...
    const getSavedVideos = async () => {
      try {
        const response = await axios.get(
             "http://localhost:4545/savedvideos"
    ...
    const noSavedVideosImageUrl = './images/nxt-watch-no-saved-videos-img.png'; // Update with your actual image path
    ...
    return (
          ...
          <div className="container-fluid">
            <div className="row">
              ...
              <div className="col-md-9">
                ...
                <div className="container-fluid">
                <div style={{marginTop:"80px",backgroundColor:darkMode ? 'white' : 'black',color:darkMode ? 'black' : 'white',padding:"10px",borderRadius:"5px",fontSize:"20px"}}><i class="ri-save-fill pr-3"></i> Saved Videos</div>
                  <div className="row">
      ...
      <p>{video.video_published_date}</p>
                    ...
                    <div className="col-12 text-center">
                      <img src={noSavedVideosImageUrl} alt="No Saved Videos" style={{ width: "700px" }} />
                      <p>No Saved Videos</p>
                    </div>
                  )
